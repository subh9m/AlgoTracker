...
const AlgoCard = ({ title, when, keywords, examples, code, slug }) => {
  ...
  return (
    <div className="relative bg-black/60 backdrop-blur-md border border-border-color rounded-2xl p-8 transition-all duration-500 ease-in-out flex flex-col h-full hover:border-red-500/50 md:hover:-translate-y-1 hover:shadow-[0_0_25px_rgba(255,0,0,0.25)]">
